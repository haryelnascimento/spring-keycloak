...
public class AuthorizationServerConfig {
    ...
    @Bean
    public AuthorizationServerSettings providerSettings(ImobSecurityProperties properties) {
    ...
    public OAuth2TokenCustomizer<JwtEncodingContext> jwtCustomizer(UserRepository userRepository) {
        return context -> {
            ...
            if (authentication.getPrincipal() instanceof User) {
                ...
                io.imob.domain.model.User usuario = userRepository.findByEmail(user.getUsername()).orElseThrow();
